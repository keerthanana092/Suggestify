...
export default function CategoryPage() {
  ...
  return (
    <main>
      ...
      <div className="container" style={{ paddingTop: result ? '6rem' : '20vh', transition: 'padding 0.8s ease' }}>
        ...
        >
          <h1>Discover {capitalize(category)}</h1>
          <p className="subtitle">Tell me what you're feeling. I'll find exactly the {category} you need.</p>
        </motion.div>
        ...
        {isLoading && (
          ...
          >
            ...
            <p className="loader-text">Feeling the {category} vibe...</p>
          </motion.div>
        )}
